    ...
    jQuery('.menutoggle,.toggle-bars').click(function () {
        ...
        if (bodypos != 'relative') {
            ...
            if (!body.hasClass('leftpanel-collapsed')) {
                ...
                jQuery('.leftpanel').css({width: '200px', overflow: 'auto'});
    ...
    jQuery('#chatview').click(function () {
        ...
        if (bodypos != 'relative') {
            ...
            if (!body.hasClass('chat-view')) {
                ...
                jQuery('.nav-bracket ul').attr('style', 'width:auto');
                jQuery('.leftpanel-collapsed .leftpanel').css({width: '50px',background: 'none',overflow:'visible'});
            } else {
                ...
                if (!jQuery('.menutoggle').hasClass('menu-collapsed')) {
                    ...
                    jQuery('.nav-bracket li.active ul').css({display: 'block',width:'100%'});
                    jQuery('.leftpanel').css({width: '220px', overflow: 'auto'});
                    //jQuery('.leftpanelinner').css({background: '#E4E7EA',width:'100%'});
                } else {
